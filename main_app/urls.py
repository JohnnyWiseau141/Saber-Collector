...
urlpatterns = [
  ...
  path('sabers/<int:saber_id>/add_photo/', views.add_photo, name='add_photo'),
  path('sabers/<int:saber_id>/assoc_crystal/<int:crystal_id>/', views.assoc_crystal, name='assoc_crystal'),
